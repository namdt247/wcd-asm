...
//                System.out.println(stringQuery.toString());
    ...
    public final List<T> findAll(int a, int b) {
        ...
        stringQuery.append(SQLConstant.SPACE);
        stringQuery.append("where status = 1 or status = 2");
        stringQuery.append(SQLConstant.SPACE);
        ...
        for (Field field1 : clazz.getDeclaredFields()) {
            ...
            if (columnInfor.columnName().equals("updatedAt")) {
                // lấy thông tin id.
...
//                System.out.println(stringQuery.toString());
    ...
    public int getCount() {
        ...
        String stringQuery = "SELECT count(id) FROM foods where status = 1 or status = 2";
        int count = 0;
        try {
            PreparedStatement preparedStatement = ConnectionHelper.getConnection().prepareStatement(stringQuery.toString());
