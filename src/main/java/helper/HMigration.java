...
public class HMigration {
    public static void main(String[] args) throws SQLException {
        // quet trong package entity
        Reflections reflections = new Reflections("entity");
        // tim ra tat ca cac class co annotation la @Entity
        ...
        GenericRepository genericRepository = new GenericRepository(Category.class);
        ...
        genericRepository.save(category1);
        genericRepository.save(category2);
        genericRepository.save(category3);
        genericRepository.save(category4);
    }
